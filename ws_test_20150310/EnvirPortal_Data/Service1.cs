    ...
    public partial class Service1 : ServiceBase
    {
        ...
        public void hisfn()
        {
            ...
            while (1 == 1)
            {
                ...
                {
                    //(new Business()).AddRemoteCalibRdsData(DateTime.Now.AddDays(-120), DateTime.Now);
                    //(new Business()).AddRemoteCalibRuleValueData(DateTime.Now.AddDays(-120), DateTime.Now);
